  ...
  return <section className="config-page">
    ...
    <div className="config-layout"><div className="settings-form">
      ...
      {profile ? <>
        ...
        <fieldset><legend><span>04</span>Official Watchlist</legend><textarea className="watchlist-editor" onChange={(event) => setWatchlist(event.target.value)} spellCheck={false} value={watchlist} /><p className="config-note">每项包含 name、HTTPS url，以及包含该 URL 主机名的 allowedHosts。</p></fieldset>
